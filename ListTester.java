...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_listIterIndex1PreviousRemoveA_emptyList, "A_listIterIndex1PreviousRemoveA_emptyList"); // list iterator test
		...
		testTwoElementList(A_listIterIndex1PreviousA_BA, "A_listIterIndex1PreviousA_BA", LIST_BA, STRING_BA); // list iterator
		//1-element to changed 1-element via set() @ADDED
		testSingleElementList(A_set0_B, "A_set0_B", LIST_B, STRING_B);
		testSingleElementList(A_listIterIndex0NextSetB_B, "A_listIterIndex0NextSetB_B", LIST_B, STRING_B); // list iterator
		testSingleElementList(A_listIterIndex1PreviousSetB_B, "A_listIterIndex1PreviousSetB_B", LIST_B, STRING_B); // list iterator
		...
		testSingleElementList(AB_listIterIndex1PreviousRemoveA_B, "AB_listIterIndex1PreviousRemoveA_B", LIST_B, STRING_B); // list iterator test
		testSingleElementList(AB_listIterIndex2PreviousRemoveB_A, "AB_listIterIndex2PreviousRemoveB_A", LIST_A, STRING_A); // list iterator test
		...
		testThreeElementList(AB_listIterAddC_CAB, "AB_listIterAddC_CAB", LIST_CAB, STRING_CAB); // list iterator
		testThreeElementList(AB_listIterIndex0NextAddC_ACB, "AB_listIterIndex0NextAddC_ACB", LIST_ACB, STRING_ACB); // list iterator
		testThreeElementList(AB_listIterIndex1NextAddC_ABC, "AB_listIterIndex1NextAddC_ABC", LIST_ABC, STRING_ABC); // list iterator
		testThreeElementList(AB_listIterIndex1PreviousAddC_CAB, "AB_listIterIndex1PreviousAddC_CAB", LIST_CAB, STRING_CAB); // list iterator
		testThreeElementList(AB_listIterIndex2PreviousAddC_ACB, "AB_listIterIndex2PreviousAddC_ACB", LIST_ACB, STRING_ACB); // list iterator
		...
		testTwoElementList(AB_listIterIndex0NextSetC_CB, "AB_listIterIndex0NextSetC_CB", LIST_CB, STRING_CB); // list iterator
		testTwoElementList(AB_listIterIndex1NextSetC_AC, "AB_listIterIndex1NextSetC_AC", LIST_AC, STRING_AC); // list iterator
		testTwoElementList(AB_listIterIndex1PreviousSetC_CB, "AB_listIterIndex1PreviousSetC_CB", LIST_CB, STRING_CB); // list iterator
		testTwoElementList(AB_listIterIndex2PreviousSetC_AC, "AB_listIterIndex2PreviousSetC_AC", LIST_AC, STRING_AC); // list iterator
		...
		testTwoElementList(ABC_listIterIndex1PreviousRemoveA_BC, "ABC_listIterIndex1PreviousRemoveA_BC", LIST_BC, STRING_BC); // list iterator test
		testTwoElementList(ABC_listIterIndex2PreviousRemoveB_AC, "ABC_listIterIndex2PreviousRemoveB_AC", LIST_AC, STRING_AC); // list iterator test
		testTwoElementList(ABC_listIterIndex3PreviousRemoveC_AB, "ABC_listIterIndex3PreviousRemoveC_AB", LIST_AB, STRING_AB); // list iterator test
	...
	/** Scenario: empty list -> addToRear(A) -> [A] @ADDED
	...
	/** Scenario: empty list -> add(A) -> [A] @ADDED
	...
	/** Scenario: empty list -> add(0,A) -> [A] @ADDED
	 * @return [A] after add(0,A)
	 */
	private IndexedUnsortedList<Integer> emptyList_addAtIndexZero_A() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.add(0,ELEMENT_A);
		return list;
	}
	private Scenario<Integer> emptyList_addAtIndexZero_A = () -> emptyList_addAtIndexZero_A();
	...
	/** Scenario: [A,B] -> removeFirst() -> [B] @ADDED
	...
	/** Scenario: [A,B] -> removeLast() -> [A] @ADDED
	...
	/** Scenario: [A,B,C] -> removeFirst() -> [B,C] @ADDED
	...
	/** Scenario: [A,B,C] -> remove(A) -> [B,C] @ADDED
	...
	/** Scenario: [A,B,C] -> remove(B) -> [A,C] @ADDED
	...
	/** Scenario: [A,B,C] -> remove(C) -> [A,B] @ADDED
	...
	/** Scenario: [A,B,C] -> remove(0) -> [B,C] @ADDED
	...
	/** Scenario: [A,B,C] -> remove(1) -> [A,C] @ADDED
	...
	/** Scenario: [A,B,C] -> remove(2) -> [A,B] @ADDED
	 ...
	 * @return [] after remove() after previous returns A
	 */
	 ...
	 * @return [B] after remove() after previous returns A
	 */
	private IndexedUnsortedList<Integer> AB_listIterIndex1PreviousRemoveA_B() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.remove();
	...
	private Scenario<Integer> AB_listIterIndex1PreviousRemoveA_B = () -> AB_listIterIndex1PreviousRemoveA_B();

	/**
	 * Scenario: [A,B] -> iterator remove() after previous() returns B -> [A]
	 * @return [A] after remove() after previous returns B
	 */
	private IndexedUnsortedList<Integer> AB_listIterIndex2PreviousRemoveB_A() {
		IndexedUnsortedList<Integer> list = A_addB_AB();
	...
	private Scenario<Integer> AB_listIterIndex2PreviousRemoveB_A = () -> AB_listIterIndex2PreviousRemoveB_A();

	/**
	 * Scenario: [A,B,C] -> iterator remove() after previous() returns A -> [B,C]
	 * @return [B,C] after remove() after previous returns A
	 */
	 ...
	 * @return [A,C] after remove() after previous returns B
	 */
	 ...
	 * @return [A,B] after remove() after previous returns C
	 */
	 ...
	 * @return [B,A] after iterator add(B) after previous() returns A
	 */
	private IndexedUnsortedList<Integer> A_listIterIndex1PreviousA_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.add(ELEMENT_B);
	...
	private Scenario<Integer> A_listIterIndex1PreviousA_BA = () -> A_listIterIndex1PreviousA_BA();
	 ...
	 * @return [A,C,B] after iterator add(C) after next() returns A
	 */
	private IndexedUnsortedList<Integer> AB_listIterIndex0NextAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterIndex0NextAddC_ACB = () -> AB_listIterIndex0NextAddC_ACB();


	/** Scenario: [A,B] -> iterator add(C) after next() returns B -> [A,B,C]
	 * @return [A,B,C] after iterator add(C) after next() returns B
	 */
	private IndexedUnsortedList<Integer> AB_listIterIndex1NextAddC_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.next();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterIndex1NextAddC_ABC = () -> AB_listIterIndex1NextAddC_ABC();

	/** Scenario: [A,B] -> iterator add(C) after previous() returns A -> [C,A,B]
	 * @return [C,A,B] after iterator add(C) after previous() returns A
	 */
	private IndexedUnsortedList<Integer> AB_listIterIndex1PreviousAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(1);
		lit.previous();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterIndex1PreviousAddC_CAB = () -> AB_listIterIndex1PreviousAddC_CAB();

	/** Scenario: [A,B] -> iterator add(C) after previous() returns B -> [A,C,B]
	 * @return [A,C,B] after iterator add(C) after previous() returns B
	 */
	private IndexedUnsortedList<Integer> AB_listIterIndex2PreviousAddC_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> lit = list.listIterator(2);
		lit.previous();
		lit.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIterIndex2PreviousAddC_ACB = () -> AB_listIterIndex2PreviousAddC_ACB();

	/** Scenario: [A] -> iterator set(B) after next() returns A -> [B]
	 * @return [B] after iterator set(B) after next() returns A
	 */
	private IndexedUnsortedList<Integer> A_listIterIndex0NextSetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
		lit.set(ELEMENT_B);
	...
	private Scenario<Integer> A_listIterIndex0NextSetB_B = () -> A_listIterIndex0NextSetB_B();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIterAdd", testListIterAdd(scenario.build().listIterator(), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterSet", testListIterSet(scenario.build().listIterator(), ELEMENT_X, Result.IllegalState));
				// at indexed position one of two element list
				printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIterNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
				// at indexed position two of two element list
				...
				printTest(scenarioName + "_testListIterNextNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1)), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2), ELEMENT_X, Result.NoException));
				// at indexed position zero of two element list
				printTest(scenarioName + "_testListIter0HasNext", testIterHasNext(scenario.build().listIterator(0), Result.True));
				printTest(scenarioName + "_testListIter0Next", testIterNext(scenario.build().listIterator(0), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIter0NextIndex", testListIterNextIndex(scenario.build().listIterator(0), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIter0HasPrevious", testListIterHasPrevious(scenario.build().listIterator(0), Result.False));
				...
				printTest(scenarioName + "_testListIter0NextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter0NextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));
				// at index position one of two element list
				...
				printTest(scenarioName + "_testListIter1PreviousNextAdd", testListIterAdd(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter1PreviousNextSet", testListIterSet(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), ELEMENT_X, Result.NoException));
				// at index position two of two element list
				...
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextRemove", testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2), Result.NoException));
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextAdd", testListIterAdd(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter2PreviousPreviousNextNextSet", testListIterSet(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 2), ELEMENT_X, Result.NoException));
		  } else {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.UnsupportedOperation));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.UnsupportedOperation));
		  }
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove0" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[2], Result.MatchingValue));
			...
			printTest(scenarioName + "_testContains0" + contentsString.charAt(0), testContains(scenario.build(), contents[2], Result.True));
			printTest(scenarioName + "_testContains1" + contentsString.charAt(1), testContains(scenario.build(), contents[2], Result.True));
			...
			printTest(scenarioName + "_testAddToFront", testAddToFront(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddToRear", testAddToRear(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfter0" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[2], ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAddAfter1" + contentsString.charAt(1), testAddAfter(scenario.build(), contents[2], ELEMENT_X, Result.NoException));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				// beginning of three element list
				printTest(scenarioName + "_testListIterHasNext", testIterHasNext(scenario.build().listIterator(), Result.True));
				printTest(scenarioName + "_testListIterNext", testIterNext(scenario.build().listIterator(), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIterNextIndex", testListIterNextIndex(scenario.build().listIterator(), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIterHasPrevious", testListIterHasPrevious(scenario.build().listIterator(), Result.False));
				...
				printTest(scenarioName + "_testListIterAdd", testListIterAdd(scenario.build().listIterator(), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterSet", testListIterSet(scenario.build().listIterator(), ELEMENT_X, Result.IllegalState));
				// at indexed position one of three element list
				printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIterNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
				// at indexed position two of three element list
				printTest(scenarioName + "_testListIterNextNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 2), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextNextPreviousPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 2), ELEMENT_X, Result.NoException));
				// at indexed position three of three element list
				...
				printTest(scenarioName + "_testListIterNextNextNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 3)), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIterNextNextNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1)), Result.IllegalState));
				...
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextNextNextPreviousPreviousPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 3), ELEMENT_X, Result.NoException));
				// at indexed position zero of three element list
				printTest(scenarioName + "_testListIter0HasNext", testIterHasNext(scenario.build().listIterator(0), Result.True));
				printTest(scenarioName + "_testListIter0Next", testIterNext(scenario.build().listIterator(0), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIter0NextIndex", testListIterNextIndex(scenario.build().listIterator(0), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIter0HasPrevious", testListIterHasPrevious(scenario.build().listIterator(0), Result.False));
				...
				printTest(scenarioName + "_testListIter0NextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter0NextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));
				// at index position one of three element list
				printTest(scenarioName + "_testListIter1HasNext", testIterHasNext(scenario.build().listIterator(1), Result.True));
				printTest(scenarioName + "_testListIter1Next", testIterNext(scenario.build().listIterator(1), contents[1], Result.MatchingValue));
				printTest(scenarioName + "_testListIter1NextIndex", testListIterNextIndex(scenario.build().listIterator(1), 1, Result.MatchingValue));
				printTest(scenarioName + "_testListIter1HasPrevious", testListIterHasPrevious(scenario.build().listIterator(1), Result.True));
				...
				printTest(scenarioName + "_testListIter1PreviousNextAdd", testListIterAdd(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter1PreviousNextSet", testListIterSet(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(1), 1), 1), ELEMENT_X, Result.NoException));
				// at index position two of three element list
				...
				printTest(scenarioName + "_testListIter3PreviousPreviousNextNextRemove", testIterRemove(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 2), Result.NoException));
				printTest(scenarioName + "_testListIter3PreviousPreviousNextNextAdd", testListIterAdd(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter3PreviousPreviousNextNextSet", testListIterSet(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(3), 2), 2), ELEMENT_X, Result.NoException));
		  } else {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.UnsupportedOperation));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.UnsupportedOperation));
		  }
